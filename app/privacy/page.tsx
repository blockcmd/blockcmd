  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          Website refers to BlockCMD.com, accessible from{" "}
          <a href="https://www.blockcmd.com">https://www.blockcmd.com</a>
        </li>
        <li>
      ...
      <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
        As a visitor to the blockcmd.com website
      </h4>
      <p>
        The privacy of our website visitors is important to us so we do not
        track any individual people. As a visitor to the blockcmd.com website:
      </p>
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
